...
right = [
         # Muhammad was a founding father of astronomy. https:#en.wikipedia.org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4%81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB
        "albattani",
...
def get_random_name(a, b):
    if a is not None and b is not None:
        return left[a] + "_" + right[b]
    else:
        return left[random.randint(0, len(left) - 1)] + "_" + right[random.randint(0, len(right) - 1)]
